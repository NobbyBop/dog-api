...
import type { Dog, Breed, AdoptionApplication, HealthRecord, TrainingRecord } from '../schemas'
...
export const mockDogs: Dog[] = [
  {
    ...
    description: "Buddy is a lovable Golden Retriever who loves playing fetch and swimming. He's great with kids and other dogs.",
  ...
  },
  {
    ...
    description: "Luna is a brilliant Border Collie who excels at agility training. She needs an active family who can keep up with her energy.",
    createdAt: randomDate(new Date(2023, 0, 1), new Date()),
    updatedAt: randomDate(new Date(2023, 0, 1), new Date())
  },
  {
    ...
    description: "Max is a noble German Shepherd with excellent training. He would make a great guard dog and family companion.",
    createdAt: randomDate(new Date(2023, 0, 1), new Date()),
    updatedAt: randomDate(new Date(2023, 0, 1), new Date())
  },
  {
    ...
    isNeutered: false,
    photos: [
      "https://example.com/photos/bella1.jpg"
    ],
    description: "Bella is a charming French Bulldog puppy who loves attention and cuddles. Perfect for apartment living.",
    createdAt: randomDate(new Date(2023, 0, 1), new Date()),
    updatedAt: randomDate(new Date(2023, 0, 1), new Date())
  },
  {
    ...
    description: "Rocky is a gentle giant who loves children and playing tug-of-war. He's looking for a loving forever home.",
    createdAt: randomDate(new Date(2023, 0, 1), new Date()),
    updatedAt: randomDate(new Date(2023, 0, 1), new Date())
  }
]
...
export const mockBreeds: Breed[] = [
  {
    ...
    goodWithKids: true,
    goodWithPets: true,
    description: "Golden Retrievers are friendly, intelligent dogs that are devoted to their families. They were originally bred to retrieve waterfowl for hunters.",
  ...
  },
  {
    ...
    goodWithKids: true,
    goodWithPets: true,
    description: "Border Collies are extremely intelligent and energetic dogs that excel at herding and agility sports.",
  ...
  },
  {
    ...
    goodWithKids: true,
    goodWithPets: false,
    description: "German Shepherds are large, athletic dogs known for their loyalty, courage, and versatility as working dogs.",
  ...
  },
  {
    ...
    goodWithKids: true,
    goodWithPets: true,
    description: "French Bulldogs are small, muscular dogs with a calm nature and require minimal exercise, making them excellent city dogs.",
...
export const mockAdoptionApplications: AdoptionApplication[] = [
  {
    ...
    reason: "Looking for a loyal family companion for our children. We have experience with Golden Retrievers and love their temperament.",
    status: "pending",
  ...
  },
  {
    ...
    reason: "I'm an agility trainer and Luna would be perfect for my training programs. I have experience with Border Collies.",
    status: "approved",
...
export const mockHealthRecords: HealthRecord[] = [
  {
    ...
    cost: 150,
    followUpDate: new Date(new Date().getFullYear() + 1, new Date().getMonth(), new Date().getDate()).toISOString().split('T')[0],
  ...
  },
  {
    ...
    medications: [
      { name: "Antibiotic Ear Drops", dosage: "3 drops", frequency: "Twice daily for 10 days" }
    ],
    cost: 65,
...
export const mockTrainingRecords: TrainingRecord[] = [
  {
    ...
    certificates: ["https://example.com/certificates/buddy-basic-obedience.pdf"],
    createdAt: randomDate(new Date(2023, 0, 1), new Date()),
    updatedAt: randomDate(new Date(2023, 0, 1), new Date())
  },
  {
  ...
  },
  {
    ...
    status: "completed",
    skills: ["heel off-leash", "distance commands", "emergency recall", "advanced stay", "protection work"],
    progress: "excellent",
    cost: 800,
    notes: "Max completed advanced protection training with honors",
    certificates: ["https://example.com/certificates/max-advanced-obedience.pdf"],
    createdAt: randomDate(new Date(2023, 0, 1), new Date()),
    updatedAt: randomDate(new Date(2023, 0, 1), new Date())
  }
]
