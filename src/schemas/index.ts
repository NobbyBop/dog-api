...
export const BreedSchema = z.object({
  id: z.string().uuid(),
  name: z.string().min(1).max(100),
  group: z.enum(['sporting', 'hound', 'working', 'terrier', 'toy', 'non-sporting', 'herding', 'mixed']),
...
export const HealthRecordSchema = z.object({
  id: z.string().uuid(),
  dogId: z.string().uuid(),
  type: z.enum(['vaccination', 'checkup', 'treatment', 'surgery', 'emergency', 'dental', 'grooming']),
  date: z.string().date(),
...
export const TrainingRecordSchema = z.object({
  id: z.string().uuid(),
  dogId: z.string().uuid(),
  type: z.enum(['basic-obedience', 'advanced-obedience', 'agility', 'therapy', 'service', 'behavioral', 'socialization']),
...
export type CreateAdoptionApplication = z.infer<typeof CreateAdoptionApplicationSchema>
